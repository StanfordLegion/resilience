...
DEBUG=0 CC=cc CXX=CC HOST_CC=gcc HOST_CXX=g++ USE_GASNET=1 REALM_NETWORKS=gasnetex "$root_dir"/scripts/setup_env.py --cmake --extra='-DCMAKE_INSTALL_PREFIX=$PWD/../install'
popd
